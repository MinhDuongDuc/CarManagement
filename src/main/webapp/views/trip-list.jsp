    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <form action="${pageContext.request.contextPath}/trip/search" method="get">
                        ...
                        <tbody>
                            <c:forEach items="${tripList}" var="trip">
                                <tr>
                                    ...
                                    <td scope="row">${trip.depaturTime}</td>
                                    <td scope="row">${trip.driver}</td>
                                    <td scope="row">${trip.carType}</td>
                                    <td scope="row">${trip.maxTicket}</td>
                                    <td scope="row">
                                        <a href="${pageContext.request.contextPath}/trip/edit/${trip.tripId}"><i class="fa fa-pencil-square-o"></i> Update</a> | 
                                        <a onclick="deleteWarning('trip/delete/','${trip.tripId}')"><i class="fa fa-trash"></i> Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
