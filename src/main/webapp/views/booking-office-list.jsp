    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <form action="${pageContext.request.contextPath}/bo/search" method="get">
                        <div class="col-lg-5"></div>
                        <div class="col-lg-4 input-group">
                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                            <input type="text" name="search" class="form-control" placeholder="Booking office Search">
                        </div>
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            <c:forEach items="${boList}" var="bo">
                                <tr>
                                    <td scope="row">${bo.officeId}</td>
                                    <td scope="row"><a href="#">${bo.officeName}</a></td>
                                    <td scope="row">${bo.trip.destination}</td>
                                    <td scope="row">
                                        <a href="${pageContext.request.contextPath}/bo/edit/${bo.officeId}"><i class="fa fa-pencil-square-o"></i> Update</a> | 
                                        <a onclick="deleteWarning('bo/delete/','${bo.officeId}')"><i class="fa fa-trash"></i> Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
